...
#elif (BASE_SSD == SAMSUNG_FDP)
#define NR_NAMESPACES 1

#define NS_SSD_TYPE_0 SSD_TYPE_FDP
#define NS_CAPACITY_0 (0)
#define NS_SSD_TYPE_1 NS_SSD_TYPE_0
#define NS_CAPACITY_1 (0)
#define MDTS (6)
...
/* FDP-specific knobs (TP 4146a). Phase 1 wires storage only; behavior is
 * identical to conventional SSD. Phase 4 will use NR_RUH for per-RUH wps. */
#define FDP_NR_RG (1)
#define FDP_NR_RUH (8)
#define FDP_NR_EVENTS (63)
